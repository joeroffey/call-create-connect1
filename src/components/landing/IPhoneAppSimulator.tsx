  ...
  return (
    <div className="relative max-w-sm mx-auto">
      ...
      <div className="relative bg-black rounded-[2.5rem] p-2 shadow-2xl">
        {/* Dynamic Island */}
        <div className="absolute top-4 left-1/2 transform -translate-x-1/2 w-32 h-7 bg-black rounded-full z-50"></div>
        
        {/* Phone Screen */}
        <div className="bg-background rounded-[2rem] overflow-hidden h-[700px] w-[350px] relative flex flex-col">
          {/* Status Bar */}
          <div className="flex justify-between items-center px-6 py-2 text-xs text-muted-foreground bg-background pt-8">
            <span>9:41</span>
